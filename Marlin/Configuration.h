...
#define STRING_CONFIG_H_AUTHOR "(Gorgonbert, Bear, MK3s, SKR14T, Bondtech, TFT24, PINDA2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bear MK3s SKR14T"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //SKR MK3s V1.4
  #define DEFAULT_bedKp 53.77
  #define DEFAULT_bedKi 2.87
  #define DEFAULT_bedKd 670.63
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // 4x6 misses the magnets according to "Stahlfabrik" but "Warkocki" says 7x7 is fine
